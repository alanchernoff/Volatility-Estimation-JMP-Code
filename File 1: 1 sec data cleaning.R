...
for (i in 1:length(comp_list)){
  ticker = comp_list[i]
  df=read.csv(paste("/Users/19084/My Backup Files/Data/Data/Extra DOW data/",ticker,'_1sec_Clean.csv',sep=""),header=TRUE)
  ...
  write.table(minutedatadf,paste("C:\\Users\\19084\\My Backup Files\\Data\\Data\\"
  ...
  write.table(df5min,paste("C:\\Users\\19084\\My Backup Files\\Data\\Data\\"
  ...
  write.table(df2halfmin,paste("C:\\Users\\19084\\My Backup Files\\Data\\Data\\"
